...
<div style="font-size:13px;color:rgba(255,254,249,.8);margin-top:4px">Tu membresia esta activa</div>
</td></tr>
<tr><td style="padding:28px 28px 20px">
<p style="font-size:17px;color:#1a2e1a;margin:0 0 16px;line-height:1.5">Hola, <strong>${displayName}</strong></p>
<p style="font-size:14px;color:#3d5a3e;line-height:1.7;margin:0 0 20px">Tu suscripcion a <strong>Velo Plus</strong> esta activa. Gracias por apoyar la comunidad.</p>
...
<p style="font-size:13px;color:#3d5a3e;margin:4px 0">&#9989; Crear Circulos de Paz</p>
<p style="font-size:13px;color:#C8A560;margin:4px 0">&#9989; Insignia dorada</p>
<p style="font-size:13px;color:#3d5a3e;margin:4px 0">&#9989; Sesiones de guardian ilimitadas</p>
<p style="font-size:13px;color:#3d5a3e;margin:4px 0">&#128154; Tu suscripcion subsidia sesiones para quienes mas lo necesitan</p>
</div>
<table cellpadding="0" cellspacing="0" width="100%"><tr><td align="center">
<a href="https://velo-ashen-mu.vercel.app" style="display:inline-block;background:linear-gradient(135deg,#C8A560,#A07840);color:#fffef9;text-decoration:none;padding:13px 28px;border-radius:100px;font-size:14px;font-weight:700">Ir a Velo Plus &rarr;</a>
</td></tr></table>
</td></tr>
<tr><td style="padding:20px 28px 28px;border-top:1px solid #e8e2d6;text-align:center">
<p style="font-size:11px;color:#a09880;margin:0;line-height:1.7">Con gratitud<br><strong style="color:#3d5a3e">El equipo Velo</strong><br><a href="https://velo-ashen-mu.vercel.app" style="color:#7a9a7a;text-decoration:none">velo-ashen-mu.vercel.app</a></p>
    ...
    const amtText = amount ? `$${amount} USD` : 'tu donacion';
...
<div style="font-size:13px;color:rgba(255,254,249,.8);margin-top:4px">Recibimos tu donacion &middot; ${amtText}</div>
</td></tr>
<tr><td style="padding:28px 28px 20px">
<p style="font-size:17px;color:#1a2e1a;margin:0 0 16px;line-height:1.5">Hola, <strong>${displayName}</strong></p>
<p style="font-size:14px;color:#3d5a3e;line-height:1.7;margin:0 0 20px">Recibimos tu aporte de <strong>${amtText}</strong>. Gracias de corazon. Cada contribucion ayuda a mantener Velo gratuito.</p>
...
<p style="font-size:13px;color:#3d5a3e;margin:4px 0">&#127757; Amplia el acceso al bienestar emocional</p>
</div>
<table cellpadding="0" cellspacing="0" width="100%"><tr><td align="center">
<a href="https://velo-ashen-mu.vercel.app" style="display:inline-block;background:linear-gradient(135deg,#2e5e35,#4a8a52);color:#fffef9;text-decoration:none;padding:13px 28px;border-radius:100px;font-size:14px;font-weight:700">Volver a Velo &rarr;</a>
</td></tr></table>
</td></tr>
<tr><td style="padding:20px 28px 28px;border-top:1px solid #e8e2d6;text-align:center">
<p style="font-size:11px;color:#a09880;margin:0;line-height:1.7">Con gratitud<br><strong style="color:#3d5a3e">El equipo Velo</strong><br><a href="https://velo-ashen-mu.vercel.app" style="color:#7a9a7a;text-decoration:none">velo-ashen-mu.vercel.app</a></p>
